...
public class ReclamationController {
    ...
    @FXML private TextField searchReservationIdField;
    @FXML private ComboBox<String> searchStatutCombo;
    @FXML private Button searchButton;
    @FXML private Button resetButton;

    @FXML private TableView<Reclamation> tableViewReclamations;
    ...
    @FXML private TableColumn<Reclamation, Integer> reservationIdCol;
